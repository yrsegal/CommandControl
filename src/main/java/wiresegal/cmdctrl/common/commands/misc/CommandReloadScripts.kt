...
object CommandReloadScripts : CommandBase() {
    ...
    override fun execute(server: MinecraftServer, sender: ICommandSender, args: Array<out String>) {
        if (sender is EntityPlayerMP || sender is MinecraftServer) {
            ...
            notifyCTRLListener(sender, this, "commandcontrol.reload.done")
        } else
    ...
    override fun getCommandUsage(sender: ICommandSender?) = CommandControl.translate("commandcontrol.reload.usage")
}
